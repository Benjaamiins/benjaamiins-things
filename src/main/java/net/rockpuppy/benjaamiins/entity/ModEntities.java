...
public class ModEntities {
    ...
    public static final EntityType<BeanGodEntity> BEAN_GOD = Registry.register(Registries.ENTITY_TYPE,
            new Identifier(Benjaamiins.MOD_ID, "bean_god"),
            FabricEntityTypeBuilder.create(SpawnGroup.CREATURE, BeanGodEntity::new)
